function gg = makeFittingStruct_GLM(sta,dtStim,dtSp,varargin)
% gg = makeFittingStruct_GLM(sta,dtSp,varargin)
%
...
% ====================================================================
% Set up structure
gg = makeFittingStruct_GLM_core(sta,dtStim,dtSp,varargin{:}); 

% % ==================================================================
% set up initial K params (stim filter, linearly parametrized)
gg.kt = (gg.ktbas'*gg.ktbas)\(gg.ktbas'*sta);
gg.k = gg.ktbas*gg.kt;
